...
public class BatchRecorder : MonoBehaviour {
    ...
    /// </summary>
    /// //TODO: we have to make sure that the FACS component is on the same GameObject as this BatchRecorder, or we need to find a way to reference it properly.
    public void SetCurrentlyProcessingFile() {
        ...
        { 
            ...
            //Get the longest duration among the agents to set the recording duration accordingly
